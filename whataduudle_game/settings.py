"""
Django settings for whataduudle_game project.
...
SESSION_COOKIE_AGE = 864000 #24 hrs in seconds
...
MIDDLEWARE = [
    ...
    'main_app.middleware.GameCleanupMiddleware', 
]
...
ROOT_URLCONF = 'whataduudle_game.urls'
